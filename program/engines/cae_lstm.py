...
class CaeTrainer(Trainer, Evaluator):
    ...
    def train_epoch(self, epoch):
        ...
        if self.rank == 0:
            ...
            loss_data = {'rec_loss': average_loss}
        ...
        with torch.no_grad():
             ...
             for i, sample in enumerate(self.eval_loader):
                ...
                if i == 1 and epoch % 10 == 0:
                        self.plot(epoch, origin_plot, output, target)
                ...
                save_losses(
                    epoch, chunk_losses,
                    os.path.join(self.save_loss_path, 'valid_losses.json'))
...
class CaeLstmTrainer(Trainer, Evaluator):
    ...
    def load_cae(self):
        ...
        checkpoint_path = os.path.join(self.config['cae']['save_checkpoint'], f'checkpoint_{load_epoch}.pth')
